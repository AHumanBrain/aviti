...
if txt.strip():
    try:
        ...
        df["Mass Needed (ng)"] = 9.8*(250/(df["Library Size"]-124)*df["Frac of Cart (%)"]) #correct calculation but inconsistent with google sheet calculator df["Unique Oligos"] * coverage / cartridge_capacity * df["Qubit Quant (ng/µL)"]
